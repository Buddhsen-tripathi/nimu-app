            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-300 px-4 py-3 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/20 dark:border-zinc-700 dark:bg-zinc-800"
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full rounded-lg border border-zinc-300 px-4 py-3 text-sm outline-none focus:border-ring focus:ring-2 focus:ring-ring/20 dark:border-zinc-700 dark:bg-zinc-800 resize-none"
                />
              </div>
